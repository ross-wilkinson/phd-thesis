...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}l*{3}{r}@{}}
        ...
        \cmidrule{2-4}
        Conditions & \multicolumn{1}{c}{Yaw ($\theta_\epsilon$)} & \multicolumn{1}{c}{Pitch ($\phi_\epsilon$)} & \multicolumn{1}{c}{Roll ($\psi_\epsilon$)} \\
        \midrule
        $10\%\ P_{max.i}$ & \\
        \hspace{4mm}70 rpm & $0.16 \pm 0.02$ & $0.14 \pm 0.02$ & $0.11 \pm 0.03$ \\
        \hdashline[1pt/3pt]
        \hspace{4mm}120 rpm & $0.22 \pm 0.03$ & $0.17 \pm 0.03$ & $0.18 \pm 0.08$ \\
        \hline
        $30\%\ P_{max.i}$ & \\
        \hspace{4mm}70 rpm & $0.19 \pm 0.05$ & $0.15 \pm 0.04$ & $0.15 \pm 0.08$ \\
        \hdashline[1pt/3pt]
        \hspace{4mm}120 rpm & $0.19 \pm 0.05$ & $0.18 \pm 0.08$ & $0.16 \pm 0.02$ \\
        \hline
        $50\%\ P_{max.i}$ & \\
        \hspace{4mm}70 rpm & $0.21 \pm 0.02$ & $0.15 \pm 0.02$ & $0.12 \pm 0.01$ \\
        \hdashline[1pt/3pt]
        \hspace{4mm}120 rpm & $0.24 \pm 0.06$ & $0.19 \pm 0.05$ & $0.17 \pm 0.05$ \\
        \bottomrule
    \end{tabular}
    \caption{The sensor performance was excellent across all conditions. Group mean ($\pm$ standard deviation) RMS error in each Euler parameter describing the yaw, pitch, and roll components of the IMU angular velocity ($rad\cdot s^{-1}$) compared to the rigid marker cluster body during non-seated cycling at three different power outputs ($10\%$, $30\%$, and $50\%$ $P_{max.i}$) and two different cadences (70 rpm and 120 rpm).}
    \label{tab:m4t2}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{}X*{4}{X}l*{3}{X}@{}}
        ...
        \midrule
        IMU vs Cluster & $-8.3$ & $11.6$ & $1.6$ & $3.5$ && $88.3$ & $1.8\%$ & $\pm 3.9 \%$ \\
        \hdashline[1pt/3pt]
